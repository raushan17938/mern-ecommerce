...
const LoginPage = () => {
	...
	const { login, loading, resendVerificationEmail } = useUserStore();
				...
				<div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
					...
					{showResend && (
						<div className='mt-4 text-center'>
							<p className='text-sm text-red-400 mb-2'>Email not verified.</p>
							<button
								onClick={() => resendVerificationEmail(email)}
								className='text-sm font-medium text-emerald-400 hover:text-emerald-300 underline focus:outline-none'
							>
